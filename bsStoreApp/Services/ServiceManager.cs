...
namespace Services
{
    public class ServiceManager : IServiceManager
    {
        ...
        public ServiceManager(IRepositoryManager repositoryManager, ILoggerService logger,IMapper mapper, IDataShaper<BookDto> dataShaper, UserManager<User> userManager, IConfiguration configuration)
        {
